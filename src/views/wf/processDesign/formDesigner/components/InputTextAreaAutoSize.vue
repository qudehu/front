<template>
  ...
  <a-input-number :min="1" v-if="!mValue" v-model:value="maxMinRows.minRows" placeholder="最小行" />
  <a-input-number :min="1" v-if="!mValue" v-model:value="maxMinRows.maxRows" placeholder="最大行" />
</template>
<script setup>
